...
<?php
    ...
    $tipo=$_POST['tipo'];
    //modifica
    $sql = "UPDATE intrumento SET cuerda='$cuerda', tipo='$tipo'  WHERE id_instrumento=$id";
...
echo "<a href='prestados.php' class='btn btn-warning'>Ver intrumentos prestados</a>";

echo "</div>"; 
echo "</div>"; 
	} else {
		echo "<p class='alert alert-danger'>Ha habido un error</p>";
        echo "<p><a class='btn btn-primary' href='editar_prestados.php??id=$fila2[id]' >Regresar</a></p>";
	}
